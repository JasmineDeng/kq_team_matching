...
def test_sample_players_by_highest_score() -> None:
    ...
    assignments: list[PlayerAssignment] = _sample_players_by_highest_score(players, 1, PlayerRole.OBJECTIVE)
...
def test_sample_players_uniformly() -> None:
    ...
    sampled_players: list[PlayerAssignment] = _sample_players_uniform(players, 6, PlayerRole.FLEX)
